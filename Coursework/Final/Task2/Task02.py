...
def topology(plot):
    ...
    sta4ad = net.addStation('sta4ad', mac='00:00:00:00:00:06', ipv6= 'fe80::4', position='150,150,0', AntennaGain = '5', AntennaHeight = '1', range=30, encrypt='wpa2', failMode='standalone', passwd= '19061006')
    sta5ad = net.addStation('sta5ad', mac='00:00:00:00:00:07', ipv6= 'fe80::5', position='170,150,0', AntennaGain = '6', AntennaHeight = '2', range=30, encrypt='wpa2', failMode='standalone', passwd= '19061006')
    sta6ad = net.addStation('sta6ad', mac='00:00:00:00:00:08', ipv6= 'fe80::6', position='200,150,0', AntennaGain = '7', AntennaHeight = '3', range=30, encrypt='wpa2', failMode='standalone', passwd= '19061006')
    
    sta7M = net.addStation('sta7M', mac='00:00:00:00:00:09', ipv6= 'fe80::7', position='25,150,0', AntennaGain = '7', AntennaHeight = '3', range=30, encrypt='wpa2', failMode='standalone', passwd= '19061006')
    sta8M = net.addStation('sta8M', mac='00:00:00:00:00:10', ipv6= 'fe80::8', position='50,150,0', AntennaGain = '7', AntennaHeight = '3', range=30, encrypt='wpa2', failMode='standalone', passwd= '19061006')
    sta9M = net.addStation('sta9M', mac='00:00:00:00:00:11', ipv6= 'fe80::9', position='75,150,0', AntennaGain = '7', AntennaHeight = '3', range=30, encrypt='wpa2', failMode='standalone', passwd= '19061006')
